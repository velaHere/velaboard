...
public interface Team {
    ...
    /**
     * Returns the team color representation.
     * <p>
     * ⚠️ Do NOT use this for displaying messages to players.
     * Use {@link #getChatColor()} instead when formatting chat or UI text.
     * </p>
     *
     * @return the internal team color
     */
    @NotNull TeamColor getColor();

    /**
     * Returns the chat formatting color for this team.
     * <p>
     * This should be used when displaying messages, names, scoreboards,
     * or any player-facing text.
     *
     * @return the chat color used for visual output
     */
