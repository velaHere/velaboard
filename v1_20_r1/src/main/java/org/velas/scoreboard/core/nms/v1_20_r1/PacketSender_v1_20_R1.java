package org.velas.scoreboard.core.nms.v1_20_r1;
...
public class PacketSender_v1_20_R1 implements PacketSender {

    private static final int DISPLAY_SLOT = 1;

    private final @NotNull Objective objective;
    private final @NotNull SidebarElements elements;
    private SEH_v1_20_R1 handler;
    private final @NotNull ServerScoreboard serverScoreboard;

    PacketSender_v1_20_R1(@NotNull SidebarElements elements) {
        ...
        this.objective = serverScoreboard.addObjective(
    ...
    void init(SidebarElementsHandler handler){
        if(!(handler instanceof SEH_v1_20_R1 handle))
            throw new ScoreboardException("Failed to initialize Sidebar");
        this.handler=handle;
    }
