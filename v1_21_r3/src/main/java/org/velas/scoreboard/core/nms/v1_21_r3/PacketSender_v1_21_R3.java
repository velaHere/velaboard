...
public class PacketSender_v1_21_R3 implements PacketSender {
    ...
    void init(SidebarElementsHandler handler){
        if(!(handler instanceof SEH_v1_21_R3 handle))
            throw new ScoreboardException("Failed to initialize Sidebar");
        this.handler=handle;
    }
