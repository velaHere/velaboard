package org.velas.scoreboard.core.nms.v1_21_r1;
...
class SidebarFactory_v1_21_R1 implements SidebarFactory {

    SidebarFactory_v1_21_R1(){}
    ...
    public @NotNull PlayerSidebar createPlayerSidebar(@NotNull BukkitScoreboardImpl scoreboard, @NotNull String title) {
        ...
        PacketSender_v1_21_R1 sender = new PacketSender_v1_21_R1(elements);
        SidebarElementsHandler handler = new SEH_v1_21_R1(elements, sender);
        sender.init(handler);
