...
class SEH_v1_20_R2 extends SidebarElementsHandler {
    ...
    SEH_v1_20_R2(@NotNull SidebarElements elements, @NotNull PacketSender_v1_20_R2 sender) {
        super(elements);
    ...
    protected @NotNull Line getOrCreateLine(int line, @NotNull String text) {
        ...
        serverScoreboard.getOrCreatePlayerScore(entry, objective).setScore(line);
