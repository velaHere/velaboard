...
class SidebarFactory_v1_20_R3 implements SidebarFactory {

    SidebarFactory_v1_20_R3(){}
    ...
    public @NotNull PlayerSidebar createPlayerSidebar(@NotNull BukkitScoreboardImpl scoreboard, @NotNull String title) {
        ...
        PacketSender_v1_20_R3 sender = new PacketSender_v1_20_R3(elements);
        SidebarElementsHandler handler = new SEH_v1_20_R3(elements, sender);
        sender.init(handler);
