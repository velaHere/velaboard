package org.velas.scoreboard.core.nms.v1_21_r4;
...
class SidebarFactory_v1_21_R4 implements SidebarFactory {

    SidebarFactory_v1_21_R4(){}
    ...
    public @NotNull PlayerSidebar createPlayerSidebar(@NotNull BukkitScoreboardImpl scoreboard, @NotNull String title) {
        ...
        PacketSender_v1_21_R4 sender = new PacketSender_v1_21_R4(elements);
        SidebarElementsHandler handler = new SEH_v1_21_R4(elements, sender);
        sender.init(handler);
