package org.velas.scoreboard.core.nms.v1_21_r5;
...
class SidebarFactory_v1_21_R5 implements SidebarFactory {

    SidebarFactory_v1_21_R5(){}
    ...
    public @NotNull PlayerSidebar createPlayerSidebar(@NotNull BukkitScoreboardImpl scoreboard, @NotNull String title) {
        ...
        PacketSender_v1_21_R5 sender = new PacketSender_v1_21_R5(elements);
        SidebarElementsHandler handler = new SEH_v1_21_R5(elements, sender);
        sender.init(handler);
