...
class SidebarFactory_v1_21_R6 implements SidebarFactory {

    SidebarFactory_v1_21_R6(){}
    ...
    public @NotNull PlayerSidebar createPlayerSidebar(@NotNull BukkitScoreboardImpl scoreboard, @NotNull String title) {
        ...
        PacketSender_v1_21_R6 sender = new PacketSender_v1_21_R6(elements);
        SidebarElementsHandler handler = new SEH_v1_21_R6(elements, sender);
        sender.init(handler);
