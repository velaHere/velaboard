...
class SidebarFactory_v1_20_R2 implements SidebarFactory {

    SidebarFactory_v1_20_R2(){}
    ...
    public @NotNull PlayerSidebar createPlayerSidebar(@NotNull BukkitScoreboardImpl scoreboard, @NotNull String title) {
        ...
        PacketSender_v1_20_R2 sender = new PacketSender_v1_20_R2(elements);
        SidebarElementsHandler handler = new SEH_v1_20_R2(elements, sender);
        sender.init(handler);
